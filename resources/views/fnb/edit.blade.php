        ...
        <form method="POST" action="{{ route('fnb.update', $fnb->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('harga_beli') is-invalid @enderror" id="harga_beli"
                    name="harga_beli" value="{{ old('harga_beli', $fnb->harga_beli) }}" required>
                @error('harga_beli')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('harga_jual') is-invalid @enderror" id="harga_jual"
                    name="harga_jual" value="{{ old('harga_jual', $fnb->harga_jual) }}" required>
                @error('harga_jual')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok"
                    name="stok" value="{{ old('stok', $fnb->stok) }}" required>
                @error('stok')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
