    ...
    <div class="col-md-12 col-lg-6">
        <form method="POST" action="{{ route('fnb.store') }}">
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="stok_type" id="stok_limit" value="limit" 
                        {{ old('stok_type', 'limit') == 'limit' ? 'checked' : '' }} required>
            ...
            <div class="mb-3" id="stok_limit_input">
                <label for="stok" class="form-label">Jumlah Stok Awal <span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
                <button class="btn btn-primary btn-sm" type="submit" {{ $priceGroups->count() == 0 ? 'disabled' : '' }}>Simpan</button>
            </div>
        </form>
    </div>
